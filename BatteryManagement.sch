...
Comment4 ""
$EndDescr
Text HLabel 5750 2800 2    50   UnSpc ~ 0
LiBatt+
Text HLabel 1650 3650 0    50   UnSpc ~ 0
LiBatt-
$Comp
...
F 1 "CHRG" H 2142 2936 50  0000 C CNN
...
F 0 "R204" V 4150 3450 50  0000 C CNN
F 1 "1.5k" V 4150 3650 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 4180 3550 50  0001 C CNN
F 3 "~" H 4250 3550 50  0001 C CNN
F 4 "0603" H 2950 -2500 50  0001 C CNN "Package"
	1    4250 3550
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "C204" H 5265 3146 50  0000 L CNN
F 1 "1uF" H 5265 3055 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 5188 2950 50  0001 C CNN
F 3 "~" H 5150 3100 50  0001 C CNN
F 4 "0603" H 5050 3200 50  0000 L TNN "Package"
F 5 "CAP CER 1UF 25V X5R 0603" H 5150 3100 50  0001 C CNN "Description"
F 6 "25V" H 5150 3050 50  0000 R TNN "Voltage Rating"
F 7 "https://www.digikey.com.au/product-detail/en/yageo/CC0603KRX5R8BB105/311-1445-1-ND/2833751" H 5150 3100 50  0001 C CNN "Link"
F 8 "Digi-Key" H 5150 3100 50  0001 C CNN "Supplier 1"
F 9 "311-1445-1-ND" H 5150 3100 50  0001 C CNN "Supplier Part Number 1"
F 10 "0.15000" H 5150 3100 50  0001 C CNN "Unit Cost A$"
	1    5150 3100
	1    0    0    -1  
$EndComp
$Comp
...
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 7288 4200 50  0001 C CNN
...
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 7180 3900 50  0001 C CNN
...
Run OUT to P-FET to PROG of MCP73213 to enable/disable charging.
...
U 1 1 5DE58FCE
P 4350 3200
F 0 "Q201" H 4556 3154 50  0000 L CNN
F 1 "BSS84" H 4556 3245 50  0000 L CNN
F 2 "TO_SOT_Packages_SMD:SOT-23" H 4550 3125 50  0001 L CIN
F 3 "http://assets.nexperia.com/documents/data-sheet/BSS84.pdf" H 4350 3200 50  0001 L CNN
	1    4350 3200
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 5DE6B36C
P 4700 3450
AR Path="/5DE6B36C" Ref="R?"  Part="1" 
AR Path="/5DC297AB/5DE6B36C" Ref="R201"  Part="1" 
F 0 "R201" H 4770 3496 50  0000 L CNN
F 1 "10K" H 4770 3405 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 4630 3450 50  0001 C CNN
F 3 "~" H 4700 3450 50  0001 C CNN
F 4 "0603" H -4050 600 50  0001 C CNN "Package"
	1    4700 3450
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Over voltage protection requires that the balance plug is inserted. Don't think there's a good way of avoiding this without back-feeding something that shouldn't be back-fed. Might be wrong.
$EndSCHEMATC
